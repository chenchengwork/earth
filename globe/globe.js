...
(function (window, document) {
    ...
    var triangulateShape = window.triangulateShape=(function () {
        /**
         * 返回两条线段的交点.
    ...
    Camera.prototype = {
        ...
        update: function () {
            ...
            projectionType = globe ? [.35, 4.5] : [0.05, 1];
    ...
    World.prototype = {
        ...
        buildGrid: function () {
            ...
            for (var deg = 0; deg < 360; deg++) {
                for (var j = 0; j < 180; j++) {
                    gridElements.push(t(deg, j), t(deg + 1, j), t(deg + 1, j + 1), t(deg + 1, j + 1), t(deg, j + 1), t(deg, j));
                }
            }
            this.geoMetry.grid.elementsCount = gridElements.length;
            this.geoMetry.grid.elements = makeElementBuffer(this.context, new Uint16Array(gridElements));
            return this;
        },
        ...
        biuldMetry: function () {
            ...
            for (var l = 0; geom.verts.length/2 > l; ++l) {
                addVert(l, 0);
            }
    ...
    Globe.prototype = {
        ...
        render: function () {
            ...
            //清空画布
            context.clearColor(backgroundColor[0], backgroundColor[1], backgroundColor[2], 1 - options.background.alpha || 0);
            context.clear(context.COLOR_BUFFER_BIT | context.DEPTH_BUFFER_BIT);
