...
export const BASE = document.currentScript.src.slice(0, -12);
export const  ARRAY = Array;

export const OBJECT = Object;
export const OBJECT_PROTOTYPE = OBJECT.prototype;
export const FLOAT_ARRAY = "undefined" != typeof Float32Array ? Float32Array : ARRAY;
 ...
 * @param callback
 */
export function caller(callback) {
    var args = arguments,
...
export function forEachLine(e, t) {
 ...
 * @returns {*[]}
 */
export function getMouseEventOffset(e) {
...
export function clamp(e, t, r) {
    return t > e ? t : e > r ? r : e
}

export function smoothstep(e) {
 ...
 * @returns {*}
 */
export function color2vec3(color) {
    ...
    function getValue(t) {
        return parseInt(color.substr(2 * t, 2), 16) / 255
    }

    "#" == color[0] && (color = color.substr(1));
    if (color.length === 3) {
 ...
 * @param coord
 */
export function project_mercator(target, coord) {
    var o = coord[0],
        a = coord[1],
        i = MATH_PI * a / 180,
 ...
 * @param coord
 */
export function project_ecef(target, coord) {
 ...
 * @returns {*}
 */
export function makeBuffer(gl, target, bufferData, bufferType) {
 ...
 * @returns {*}
 */
export function makeVertexBuffer(gl, bufferData, bufferType) {
 ...
 * @returns {*}
 */
export function makeElementBuffer(gl, bufferData, bufferType) {
 ...
 * @param buffer
 */
export function bindVertexBuffer(gl, buffer) {
 ...
 * @param buffer
 */
export function bindElementBuffer(gl, buffer) {
 ...
 * @returns {*}
 */
export function createTexture2D(gl, option) {
 ...
 * @returns {*}
 */
export function loadTexture2D(gl, url, options) {
 ...
 * @returns {*}
 */
export function getFrameBuffer(context, size) {

    var framebuffer = context.createFramebuffer();
    context.bindFramebuffer(context.FRAMEBUFFER, framebuffer);

    var texture = createTexture2D(context, {size: size});
    context.bindTexture(context.TEXTURE_2D, texture);
    context.framebufferTexture2D(context.FRAMEBUFFER, context.COLOR_ATTACHMENT0, context.TEXTURE_2D, texture, 0);

    var buffer = context.createRenderbuffer();

    context.bindRenderbuffer(context.RENDERBUFFER, buffer);
    context.renderbufferStorage(context.RENDERBUFFER, context.DEPTH_COMPONENT16, size, size);
    context.framebufferRenderbuffer(context.FRAMEBUFFER, context.DEPTH_ATTACHMENT, context.RENDERBUFFER, buffer);
 ...
 * @returns {*}
 */
export function createShader(gl, shaderType, shader, shaderName) {
 ...
 * @param fragment
 */
export function registerShaders(name, shader, vertex, fragment) {
    SHADERS[name] = shader;
 ...
 * @returns {*}
 */
export function getShader(shaderName, suffix) {
 ...
 * @returns {*}
 */
export function getProgram(gl, shaderName) {
    var has = true;
 ...
 * 2  右键单击
 */
export let MOUSE_DOWN = -1;
//标记鼠标上次按下的坐标
export let MOUSE_DOWN_POS = [0, 0];
//标记鼠标上次按下的时间
export let MOUSE_DOWN_TIME = 0;
//标记是否正在拖拽
export let MOUSE_DRAGGING = false;
/**
 * 绑定事件
 * @param canvas
 * @param eventful
 */
export function bindCanvasEvents(canvas, eventful) {
    ...
    each({
        ...
        mouseup: function (e) {
            ...
            //鼠标移动距离
                distance = vec2.dist(mousePos, MOUSE_DOWN_POS);
        ...
        mousemove: function (e) {
            ...
            if (MOUSE_DOWN === -1) {
                ...
                //移动距离小于5,认为是刚开始拖拽
                if (MOUSE_DRAGGING === false && vec2.dist(mousePos, MOUSE_DOWN_POS) < 5) {
                    MOUSE_DRAGGING = true;
    ...
    "countries": [
        {
            ...
            "label": {"name": "Belgium", "coordinate": [4.599403199999981, 50.680466334931715], "fontSize": 1.74702144}
        }, {
            "code": "BF",
            "faceCount": 81,
            "faceOffset": 171,
            ...
            "label": {"name": "Burundi", "coordinate": [30.016188000000007, -3.470893613585823], "fontSize": 1.48555934}
        }, {
            "code": "BJ",
            "faceCount": 42,
            "faceOffset": 825,
            ...
            "label": {"name": "Russia", "coordinate": [96.43939559999997, 61.58821111848236], "fontSize": 10.34348106}
        }, {
            "code": "RW",
            "faceCount": 21,
            "faceOffset": 5955,
            ...
            "label": {"name": "Rwanda", "coordinate": [29.815664399999978, -2.1225596884859947], "fontSize": 1.73839319}
        }, {
            "code": "RS",
            "faceCount": 69,
            "faceOffset": 5976,
            ...
            "label": {"name": "Serbia", "coordinate": [21.061800000000012, 43.88162156624426], "fontSize": 1.24106419}
        }, {
            "code": "LR",
            "faceCount": 33,
            "faceOffset": 6045,
            ...
            "label": {"name": "Greece", "coordinate": [21.721463999999994, 39.31344080305926], "fontSize": 1.74702144}
        }, {
            "code": "GQ",
            "faceCount": 12,
            "faceOffset": 6387,
            ...
            "label": {"name": "French Guiana", "coordinate": [-52.616282399999996, 3.2737812287979735], "fontSize": 2}
        }, {
            "code": "GE",
            "faceCount": 45,
            "faceOffset": 6501,
            ...
            "label": {"name": "Georgia", "coordinate": [43.67206080000001, 41.90313980227407], "fontSize": 1.64247012}
        }, {
            "code": "GB",
            "faceCount": 267,
            "faceOffset": 6546,
            ...
            "label": {"name": "United Kingdom", "coordinate": [-1.4351867999999968, 52.28225289486326], "fontSize": 2}
        }, {
            "code": "GA",
            "faceCount": 96,
            "faceOffset": 6813,
            ...
            "label": {"name": "Kuwait", "coordinate": [47.25584640000003, 29.240971043957767], "fontSize": 1.48555934}
        }, {
            "code": "GH",
            "faceCount": 78,
            "faceOffset": 8931,
            ...
            "label": {"name": "Oman", "coordinate": [56.558322000000004, 20.497907617110933], "fontSize": 1.64126945}
        }, {
            "code": "TN",
            "faceCount": 60,
            "faceOffset": 9069,
            ...
            "label": {"name": "Tunisia", "coordinate": [8.954078399999998, 33.68825915042876], "fontSize": 1.49404287}
        }, {
            "code": "JO",
            "faceCount": 33,
            "faceOffset": 9129,
            ...
            "label": {"name": "Jordan", "coordinate": [36.45496439999999, 30.46981339664869], "fontSize": 1.46370518}
        }, {
            "code": "HR",
            "faceCount": 57,
            "faceOffset": 9162,
            ...
            "label": {"name": "Croatia", "coordinate": [16.644286800000035, 45.41329837906038], "fontSize": 1.24156451}
        }, {
            "code": "HT",
            "faceCount": 33,
            "faceOffset": 9219,
            ...
            "label": {"name": "Portugal", "coordinate": [-8.101702799999991, 39.93464364931235], "fontSize": 1.74718821}
        }, {
            "code": "SJ",
            "faceCount": 228,
            "faceOffset": 9411,
            ...
            "label": {"name": "Svalbard", "coordinate": [16.273079999999997, 78.58471182051925], "fontSize": 3.53704762}
        }, {
            "code": "PY",
            "faceCount": 48,
            "faceOffset": 9639,
            ...
            "label": {"name": "Panama", "coordinate": [-81.42162120000002, 8.397659269443709], "fontSize": 1.41692162}
        }, {
            "code": "PG",
            "faceCount": 144,
            "faceOffset": 9783,
            ...
            "label": {"name": "Peru", "coordinate": [-75.62778479999999, -10.443795128793157], "fontSize": 4.28453016}
        }, {
            "code": "PK",
            "faceCount": 210,
            "faceOffset": 10098,
            ...
            "label": {"name": "Poland", "coordinate": [19.023224400000025, 52.21771214145786], "fontSize": 2.32899618}
        }, {
            "code": "ZM",
            "faceCount": 117,
            "faceOffset": 10638,
            ...
            "label": {"name": "Zambia", "coordinate": [26.413372800000005, -14.962915040046475], "fontSize": 2.80825186}
        }, {
            "code": "EH",
            "faceCount": 60,
            "faceOffset": 10755,
            ...
            "label": {"name": "Western Sahara", "coordinate": [-14.162541503906247, 23.6904081733544], "fontSize": 2}
        }, {
            "code": "EE",
            "faceCount": 39,
            "faceOffset": 10815,
            ...
            "label": {"name": "Estonia", "coordinate": [25.65830519999998, 58.55728772964739], "fontSize": 1.78206873}
        }, {
            "code": "EG",
            "faceCount": 105,
            "faceOffset": 10854,
            ...
            "label": {"name": "Angola", "coordinate": [17.67928680000002, -12.545607369455082], "fontSize": 2.98751664}
        }, {
            "code": "ET",
            "faceCount": 108,
            "faceOffset": 11445,
            ...
            "label": {"name": "Ethiopia", "coordinate": [39.06191159999999, 8.416568175032186], "fontSize": 2.20393252}
        }, {
            "code": "ZW",
            "faceCount": 66,
            "faceOffset": 11553,
            ...
            "label": {"name": "Spain", "coordinate": [-3.589948799999998, 40.20648131627003], "fontSize": 2.20047855}
        }, {
            "code": "ER",
            "faceCount": 51,
            "faceOffset": 11733,
            ...
            "label": {"name": "Eritrea", "coordinate": [38.14341120000001, 15.32787680773013], "fontSize": 1.64827192}
        }, {
            "code": "ME",
            "faceCount": 18,
            "faceOffset": 11784,
            ...
            "label": {"name": "Moldova", "coordinate": [28.58047200000003, 46.996617215185424], "fontSize": 1.49437642}
        }, {
            "code": "MG",
            "faceCount": 99,
            "faceOffset": 11826,
            ...
            "label": {"name": "Morocco", "coordinate": [-6.253822800000011, 31.960017723700318], "fontSize": 2.81246758}
        }, {
            "code": "UZ",
            "faceCount": 159,
            "faceOffset": 12000,
            ...
            "label": {"name": "Mali", "coordinate": [-2.277280800000001, 17.109709980008002], "fontSize": 3.20683718}
        }, {
            "code": "MN",
            "faceCount": 156,
            "faceOffset": 12576,
            ...
            "label": {"name": "United States", "coordinate": [-100.0299024, 38.57099460960616], "fontSize": 8.97361469}
        }, {
            "code": "MW",
            "faceCount": 60,
            "faceOffset": 14634,
            ...
            "label": {"name": "Malawi", "coordinate": [33.75626399999998, -13.57104861478695], "fontSize": 1.60014021}
        }, {
            "code": "MR",
            "faceCount": 84,
            "faceOffset": 14694,
            ...
            "label": {"name": "Ukraine", "coordinate": [31.135694399999995, 49.06125288594917], "fontSize": 3.08472538}
        }, {
            "code": "MX",
            "faceCount": 291,
            "faceOffset": 15069,
            ...
            "label": {"name": "Israel", "coordinate": [34.622578799999964, 31.476320084307606], "fontSize": 1.42111897}
        }, {
            "code": "FR",
            "faceCount": 198,
            "faceOffset": 15390,
            ...
            "label": {"name": "France", "coordinate": [2.674303199999999, 46.574271046518994], "fontSize": 2.47068667}
        }, {
            "code": "FI",
            "faceCount": 171,
            "faceOffset": 15588,
            ...
            "label": {"name": "Finland", "coordinate": [26.19995400000001, 63.0149856078028], "fontSize": 2.81310725}
        }, {
            "code": "NI",
            "faceCount": 54,
            "faceOffset": 15759,
            ...
            "label": {"name": "Namibia", "coordinate": [16.988817600000004, -21.97705673355394], "fontSize": 2.6026473}
        }, {
            "code": "NE",
            "faceCount": 99,
            "faceOffset": 16818,
            ...
            "label": {"name": "Niger", "coordinate": [9.205027200000004, 17.253466088661852], "fontSize": 3.09488964}
        }, {
            "code": "NG",
            "faceCount": 132,
            "faceOffset": 16917,
            ...
            "label": {"name": "Nigeria", "coordinate": [7.899894000000018, 8.696139207785974], "fontSize": 3.25225782}
        }, {
            "code": "NZ",
            "faceCount": 186,
            "faceOffset": 17049,
            ...
            "label": {"name": "Canada", "coordinate": [-110.27687399999999, 58.31839051463935], "fontSize": 9.28478718}
        }, {
            "code": "CG",
            "faceCount": 102,
            "faceOffset": 24570,
            ...
            "label": {"name": "Central African Republic", "coordinate": [20.8845936, 6.012409216700622], "fontSize": 2}
        }, {
            "code": "CD",
            "faceCount": 213,
            "faceOffset": 24771,
            ...
            "label": {"name": "Cuba", "coordinate": [-79.29335160000001, 21.792525163461377], "fontSize": 2.77551079}
        }, {
            "code": "SZ",
            "faceCount": 15,
            "faceOffset": 25191,
            ...
            "label": {"name": "Kenya", "coordinate": [37.870970400000004, 0.6679395623199708], "fontSize": 2.74961686}
        }, {
            "code": "SR",
            "faceCount": 48,
            "faceOffset": 25413,
            ...
            "label": {"name": "Slovakia", "coordinate": [19.332993599999988, 48.71675314744338], "fontSize": 1.62078226}
        }, {
            "code": "KR",
            "faceCount": 87,
            "faceOffset": 25566,
            ...
            "label": {"name": "Slovenia", "coordinate": [14.685623999999994, 45.98586990036057], "fontSize": 1.24156451}
        }, {
            "code": "KP",
            "faceCount": 93,
            "faceOffset": 25692,
            ...
            "label": {"name": "Somalia", "coordinate": [47.62406159999998, 9.256610851447695], "fontSize": 2.46764994}
        }, {
            "code": "SN",
            "faceCount": 93,
            "faceOffset": 25863,
            ...
            "label": {"name": "Saudi Arabia", "coordinate": [44.2665972, 24.695591125603833], "fontSize": 3.30666351}
        }, {
            "code": "SE",
            "faceCount": 336,
            "faceOffset": 27030,
            ...
            "label": {"name": "Sweden", "coordinate": [15.179281200000005, 60.131109594710814], "fontSize": 2.5176456}
        }, {
            "code": "SD",
            "faceCount": 174,
            "faceOffset": 27366,
            ...
            "label": {"name": "Sudan", "coordinate": [29.808478800000003, 14.051733809367084], "fontSize": 3.24106431}
        }, {
            "code": "DO",
            "faceCount": 45,
            "faceOffset": 27540,
            ...
            "label": {"name": "Germany", "coordinate": [9.702619200000004, 50.975781600987865], "fontSize": 2.56195498}
        }, {
            "code": "YE",
            "faceCount": 81,
            "faceOffset": 27882,
            ...
            "label": {"name": "Yemen", "coordinate": [46.71177839999999, 14.749697730745703], "fontSize": 2.59275961}
        }, {
            "code": "DZ",
            "faceCount": 126,
            "faceOffset": 27963,
            ...
            "label": {"name": "Macedonia", "coordinate": [21.71678399999998, 41.54263511077187], "fontSize": 0.86234677}
        }, {
            "code": "UY",
            "faceCount": 48,
            "faceOffset": 28104,
            ...
            "label": {"name": "Turkey", "coordinate": [35.35143480000002, 39.09188274324174], "fontSize": 1.81811774}
        }, {
            "code": "LK",
            "faceCount": 42,
            "faceOffset": 28599,
            ...
            "label": {"name": "Latvia", "coordinate": [25.729034400000018, 56.79200183701485], "fontSize": 1.65975261}
        }, {
            "code": "LT",
            "faceCount": 36,
            "faceOffset": 28686,
            ...
            "label": {"name": "Lithuania", "coordinate": [23.87469599999996, 55.44003576767267], "fontSize": 1.74277961}
        }, {
            "code": "TM",
            "faceCount": 156,
            "faceOffset": 28722,
            ...
            "label": {"name": "Thailand", "coordinate": [102.21910560000002, 15.59937675681839], "fontSize": 2.06002593}
        }, {
            "code": "TG",
            "faceCount": 33,
            "faceOffset": 29154,
            ...
            "label": {"name": "Chad", "coordinate": [18.166773600000003, 14.626681683324195], "fontSize": 3.23360968}
        }, {
            "code": "LY",
            "faceCount": 96,
            "faceOffset": 29283,
            ...
            "label": {"name": "Libya", "coordinate": [16.65790920000002, 27.499397107171873], "fontSize": 3.96832848}
        }, {
            "code": "AE",
            "faceCount": 48,
            "faceOffset": 29379,
            ...
            "label": {"name": "Iceland", "coordinate": [-18.226054799999996, 64.6610264675878], "fontSize": 4.5736599}
        }, {
            "code": "IR",
            "faceCount": 285,
            "faceOffset": 30084,
            ...
            "label": {"name": "Armenia", "coordinate": [44.75671919999999, 40.156119713272865], "fontSize": 1.47759461}
        }, {
            "code": "AL",
            "faceCount": 36,
            "faceOffset": 30405,
            ...
            "label": {"name": "Albania", "coordinate": [20.09017079999998, 40.89399791440362], "fontSize": 0.95357287}
        }, {
            "code": "VN",
            "faceCount": 225,
            "faceOffset": 30441,
            ...
            "label": {"name": "Vietnam", "coordinate": [107.73718559999998, 11.408907621215844], "fontSize": 1.39062405}
        }, {
            "code": "AQ",
            "faceCount": 1923,
            "faceOffset": 30666,
            ...
            "label": {"name": "Austria", "coordinate": [14.594875199999997, 47.538634140696125], "fontSize": 1.74702144}
        }, {
            "code": "IN",
            "faceCount": 621,
            "faceOffset": 33936,
