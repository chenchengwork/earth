import logo from './texture/logo.png';
...
export default class Earth {
    ...
    static registerTheme = (name, option, inherit) => {
     ...
     * @returns {Controller}
     */
    lookAt(long, lat, speed, zoomLevel) {
        //经度
     ...
     * @returns {Controller}
     */
    lookAtCountry(codeOrID, speed, zoomLevel) {
        //获取country
     ...
     *  使地球转向到某个标记的位置
     */
    lookAtMark(index, speed, zoomLevel) {
